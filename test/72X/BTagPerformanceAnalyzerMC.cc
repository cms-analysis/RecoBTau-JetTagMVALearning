...
/////	BTagDifferentialPlot * etaConstDifferentialPlot = new BTagDifferentialPlot(effBConst, BTagDifferentialPlot::constETA, folderName, mcPlots_);
/////	  differentialPlotsConstantEta->push_back ( etaConstDifferentialPlot );
/////	}

/////	for ( int iPt = iPtStart ; iPt < iPtEnd ; iPt++ ) {
/////	  // differentialPlots for this pt bin
/////	  BTagDifferentialPlot * ptConstDifferentialPlot = new BTagDifferentialPlot(effBConst, BTagDifferentialPlot::constPT, folderName, mcPlots_);
...
/*
void BTagPerformanceAnalyzerMC::endJob(DQMStore::IBooker & ibook, DQMStore::IGetter & iget)
{
/////  if (!finalize) return;
  setTDRStyle();
